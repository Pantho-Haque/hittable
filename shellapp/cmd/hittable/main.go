...
//
//	go build -ldflags "-X main.version=v1.2.3" ./cmd/hittable
//
// A source build leaves it as "dev", which is the honest answer for one.
var version = "dev"
...
plain .hit files (shared with the Hittable web app), variables in hittable/env.json.
  ...
  hittable uninstall           remove hittable, its data and the model from this machine`,
...
var uninstallCmd = &cobra.Command{
	Use:   "uninstall",
	Short: "Remove hittable, its data and any downloaded model from this machine",
	Args:  cobra.NoArgs,
	RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	rootCmd.AddCommand(initCmd, updateCmd, uninstallCmd, modelCmd, versionCmd)
}
